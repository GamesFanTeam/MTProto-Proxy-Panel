...
#   PORT=8443 SERVER_IP=203.0.113.10 sudo -E bash ./mtproto-seriyps-faketls-v1.0.sh
#   ROTATE_SECRET=1 sudo -E bash ./mtproto-seriyps-faketls-v1.0.sh
...
============================================================
Проект:        seriyps/mtproto_proxy ${UPSTREAM_VERSION}
